...
using CustomerBankingService.Api.Filters;
...
namespace CustomerBankingService.Api.Configuration
{
            ...
            services.AddSwaggerGen(
                options =>
                {
                    options.SwaggerDoc(
                        ...
                        {
                            Version = "v1",
                            Title = "CustomerBankingService API",
                        });
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.SwaggerEndpoint("/swagger/v1/swagger.json", "CustomerBankingService API V1");
                    options.OAuthAppName("CustomerBankingService API");
